$(function () {
    ...
    if (!$salesChartMain.length || typeof Chart === 'undefined') {
        return;
    }

    var salesChartMainCanvas = $salesChartMain.get(0).getContext('2d');
    var dataArray = function (key) {
        var value = $salesChartMain.data(key);
    ...
    new Chart(salesChartMainCanvas, {
        type: 'bar',
        data: {
